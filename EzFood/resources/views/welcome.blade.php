<x-guest-layout>
    ...
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
        style="background-image: url('./image/foodback.jpg')">
        <h1
            ...
            <span class="inline md:block">Welcome EzFood Restaurant</span>
        </h1>
        <div class="mx-auto mt-2 text-gradient-to-r from-green-400 to-blue-500 md:text-center lg:text-lg">
            Get your fav and delicious food
        </div>
    ...
    <section class="pt-4 pb-12 bg-gray-800">
        ...
        <div class="grid gap-2 lg:grid-cols-3">
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                ...
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Youtuber</h2>
                    <p class="mt-2 text-gray-600">ឆ្ងាញ់ខ្លាំងណាស់!!</p>
                </div>
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Puy Huy</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
                ...
                <div>
                    <h2 class="text-3xl font-semibold text-gray-800">Footballer</h2>
                    <p class="mt-2 text-gray-600">Best test,amazing restaurent</p>
                </div>
                <div class="flex justify-end mt-4">
                    <a href="#" class="text-xl font-medium text-green-500">Chhinlong</a>
                </div>
            </div>
            <div class="max-w-md p-4 bg-white rounded-lg shadow-lg">
                <div class="flex justify-center -mt-16 md:justify-end">
