...
<head>
    ...
    <title>{{ config('app.name', 'EzFood') }}</title>
...
<body class="font-sans antialiased">
    <div class="flex-col w-full md:flex md:flex-row md:min-h-screen">
        <div @click.away="open = false"
            class="flex flex-col flex-shrink-0 w-full text-gray-700 bg-slate-100 md:w-40 dark:text-gray-200 dark:bg-gray-800"
            x-data="{ open: false }">
            <div class="flex flex-row items-center justify-between flex-shrink-0 px-8 py-4">
                <div class="flex-column">
                <img src="../image/logo.png" alt="" class="w-20 h-20">
                <a href="#"
                    class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark:text-white focus:outline-none focus:shadow-outline">EzFood
                </a>
                </div>
            ...
            <nav :class="{'block': open, 'hidden': !open}"
                class="flex-grow px-2 pb-2 md:block md:pb-0 md:overflow-y-auto">
                ...
                <x-admin-nav-link :href="route('admin.employees.index')"
                    :active="request()->routeIs('admin.emploees.index')">
                    {{ __('Employees') }}
                </x-admin-nav-link>
