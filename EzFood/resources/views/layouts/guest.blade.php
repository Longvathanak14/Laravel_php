...
<body>
    <div class="bg-white shadow-md navbar align-center" x-data="{ isOpen: false }">
        <nav class="container px-6 py-2  mx-auto md:flex md:justify-between md:items-center ">
            ...
            <div :class="isOpen ? 'flex' : 'hidden'"
                ...
                <a class=" bg-clip-text bg-gradient-to-r from-green-400   "
                    href="{{ route('login') }}">
                    <div class="rounded-lg p-2 flex bg-gray hover:text-white-800 from-green-400 to-blue-500 hover:from-green-400 hover:text-gray-800 box-shadow">
                    <img src="./image/user.png" class="mr-2 " width="25px" alt=""> login
                    </div>
                    </a>
